<template>
	<view class="m-item" :id="'message'+id">
		<view class="m-left">
			<image class="head_icon" src="../../static/img/tabbar/homeactive.png" v-if="message.user=='home'"></image>
		</view>
		...
		<view class="m-right">
			<image class="head_icon" src="../../static/logo.png" v-if="message.user=='customer'"></image>
		</view>
	</view>
</template>
